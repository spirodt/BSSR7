...
{
    public partial class FrmPregledNaZalihaPoKolicina : frmReport
    {
        public FrmPregledNaZalihaPoKolicina()
        {
            InitializeComponent();
        }

        private void FrmPregledNaZalihaPoKolicina_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the '_BSSR_2_0DataSet.KoliciniNaArtikli' table. You can move, or remove it, as needed.
            koliciniNaArtikliTableAdapter.Fill(_BSSR_2_0DataSet.KoliciniNaArtikli);
