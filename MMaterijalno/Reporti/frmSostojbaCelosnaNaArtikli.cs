...
{
    public partial class frmSostojbaCelosnaNaArtikli : frmIzvestaj
    {
        public frmSostojbaCelosnaNaArtikli()
        {
            InitializeComponent();
        }

        private void frmSostojbaCelosnaNaArtikli_Load(object sender, EventArgs e)
        {
           
            viewZalihaCelosnaTableAdapter.FillAll(materijalnoDataSet.viewZalihaCelosna);
        }
        ...
        private void btnPecati1_Click(object sender, EventArgs e)
        {
            ...
            var middleColumn = String.Format("Залиха " );
