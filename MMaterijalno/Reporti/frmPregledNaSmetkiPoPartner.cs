...
{
    public partial class frmPregledNaSmetkiPoPartner : frmIzvestaj
    {
        public frmPregledNaSmetkiPoPartner()
        {
            InitializeComponent();
        }
        ...
        private void btnPotvrdi1_Click(object sender, EventArgs e)
        {
            ...
            siteSmetkiZaPartnerTableAdapter.FillByDatumPocetokAndPartnerID(materijalnoDataSet.SiteSmetkiZaPartner,new DateTime(datumOd.DateTime.Year,
