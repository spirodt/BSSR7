...
{
    public partial class frmPotroseniMaterijali : frmIzvestaj
    {
        ...
        public frmPotroseniMaterijali()
        {
            InitializeComponent();
            ChangeTimeout(potroseniMaterijaliZaPeriodTableAdapter, 0);
        }
        ...
        private void btnPotvrdi1_Click(object sender, EventArgs e)
        {
            ...
            if (rbtnSite.Checked)
            {
                ...
                {
                    potroseniMaterijaliZaPeriodTableAdapter.Fill(bSSRDataSet.PotroseniMaterijaliZaPeriod, new DateTime(datumOd.DateTime.Year,
