...
{
    public partial class frmPregledNaFiskalniSmetki : frmIzvestaj
    {
        public frmPregledNaFiskalniSmetki()
        {
            InitializeComponent();
        }
        ...
        {
            fiskalniSmetkiIzvestajTableAdapter.Fill(bSSRDataSet.FiskalniSmetkiIzvestaj, new DateTime(datumOd.DateTime.Year,
        ...
        private void btnPecati1_Click(object sender, EventArgs e)
        {
            ...
            middleColumn = String.Format("Преглед на отпечатени фискални сметки за период од: {0}  до: {1}", datumOd.DateTime.ToShortDateString(), DatumDo.DateTime.ToShortDateString());
        ...
        private void frmPregledNaFiskalniSmetki_Load(object sender, EventArgs e)
        {
