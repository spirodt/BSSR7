...
{
    public partial class frmKDFI : frmIzvestaj
    {
        public frmKDFI()
        {
            InitializeComponent();
        ...
        private void btnPecati1_Click(object sender, EventArgs e)
        {
            ...
            var middleColumn = String.Format("Книга на дневни финансиски извештаи : {0}  до: {1}", datumOd.DateTime.ToShortDateString(), DatumDo.DateTime.ToShortDateString());
        ...
        private void btnPotvrdi1_Click(object sender, EventArgs e)
        {
            ...
            dnevenPrometKDFITableAdapter.Fill(bSSRDataSet.DnevenPrometKDFI, new DateTime(datumOd.DateTime.Year,
