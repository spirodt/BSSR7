...
namespace uFR
{
    ...
    enum DLOGIC_CARD_TYPE
    {
        ...
        // ST Product ID-s:
        M24SR02 = 0x82,
        M24SR02_AUTOMOTIVE = 0x8A,
        M24SR04 = 0x86,
        M24SR04_AUTOMOTIVE = 0x8E,
        M24SR16 = 0x85,
        M24SR16_AUTOMOTIVE = 0x8D,
        M24SR64 = 0x84,
        M24SR64_AUTOMOTIVE = 0x8C,
    ...
    public static class uFCoder
    {
        ...
        const string DLL_PATH = @"C:\BSS\ufr-lib\windows\x86\";
        ...
        public static void uFrOpen()
        {
            ...
            string DllPath = @"C:\BSS\ufr-lib\windows\x86\"; // for x86 target
        ...
        //---------------------------------------------------------------------
        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "MFP_ChangeSectorKeyExt_PK")]
        public static extern DL_STATUS MFP_ChangeSectorKeyExt_PK(byte sector_nr, byte auth_mode, [In] byte[] old_sector_key, [In] byte[] new_sector_key, byte new_key_type);
        

        //---------------------------------------------------------------------
        [DllImport(DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "MFP_ChangeSectorKeyExt")]
        public static extern DL_STATUS MFP_ChangeSectorKeyExt(byte sector_nr, byte auth_mode, byte key_index, [In] byte[] new_sector_key, byte new_key_type);
