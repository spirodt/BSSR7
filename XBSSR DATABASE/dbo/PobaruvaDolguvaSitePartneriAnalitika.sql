--exec PobaruvaDolguvaSitePartneriAnalitika  '2023-05-27 18:12:44.083'
CREATE  PROCEDURE [dbo].[PobaruvaDolguvaSitePartneriAnalitika] (   
   @DatumKraj datetime    
)  
AS  
BEGIN  
   DECLARE @DatumPocetok datetime 
   SET @DatumPocetok = (Select min(Datum) from tblDokumenti)
