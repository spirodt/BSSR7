CREATE PROCEDURE [dbo].[SaldoPoDokumentPoPartner] 
	@tblPartnerSifra nvarchar(20),
	@DoDatum DateTime
AS
--exec SaldoPoDokument 0, '2023-04-15 00:00:00.000'
--exec SaldoPoDokumentPoPartner '10-092','2023-05-13 00:00:00.000'
BEGIN
...
where ( Sifra = @tblPartnerSifra or (@tblPartnerSifra = '0') ) AND convert(date,DatumNaValuta,23) < convert(date,@DoDatum,23)
